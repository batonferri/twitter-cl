      ...
      <div>
        {Object.values(providers).map((provider) => (
          <div key={provider.name}>
            ...
            <button
              className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded-full hover:bg-white group"
